...
class Ergebnis(tk.Frame):
    def __init__(self, parent, controller):
        ...
        text1 = tk.Label(textframe, text='Wie hoch der Bedarf genau sein wird, hängt unter anderem davon ab,\n'
                                         ...
                                         'im Fokus stehen. Derzeit sollte insbesondere die Entwicklung bei '
                                         'Onshore-Wind\n '
                                         'zum Beispiel durch eine Erhöhung der Ausschreibungsmengen, der Ausweisung '
                                         'von\n '
                                         'mehr Flächen und einer Verbesserung des Genehmigungsprozesses beschleunigt '
                                         'werden.')
