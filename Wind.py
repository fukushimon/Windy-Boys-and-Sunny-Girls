...
# Produkt 2
        produktFrame1 = tk.Frame(windFrame)
        produktFrame1.config(background='blue')  # style.BACKGROUND)
        produktFrame1.pack(side=tk.TOP, fill=tk.X, padx=10, pady=8)  # (row=0, column=0)

        Hersteller = tk.Label(produktFrame1, text='Hersteller', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Hersteller.grid(row=0, column=0, padx=5, pady=3)
        windFrame.cbx_Hersteller = ttk.Combobox(produktFrame1, width=50)
        Hersteller = ('', 'Enercon', 'Vestas', 'Siemens-Gamesa', 'Nordex')
        windFrame.cbx_Hersteller['values'] = Hersteller
        windFrame.cbx_Hersteller.current(0)
        windFrame.cbx_Hersteller.grid(row=0, column=1)

        Standort = tk.Label(produktFrame1, text='Standort', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Standort.grid(row=1, column=0, padx=5, pady=3)
        windFrame.cbx_Standort = ttk.Combobox(produktFrame1, width=50)
        Standort = ('', 'Schleswig-Holstein A', 'Schleswig-Holstein B', 'Schleswig-Holstein C',
                    'Schleswig-Holstein D', 'Schleswig-Holstein E', 'Schleswig-Holstein F', 'Hamburg')
        windFrame.cbx_Standort['values'] = Standort
        windFrame.cbx_Standort.current(0)
        ...
        Modellname = tk.Label(produktFrame1, text='Modellname', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Modellname.grid(row=0, column=2, padx=5, pady=3)
        windFrame.cbx_Modellname = ttk.Combobox(produktFrame1, width=50)
        Modellname = ('', 'AAA', 'BBB', 'CCC', 'DDD', 'EEE',)
        windFrame.cbx_Modellname['values'] = Modellname
        windFrame.cbx_Modellname.current(0)
        windFrame.cbx_Modellname.grid(row=0, column=3)

        label1 = tk.Label(produktFrame1, text='Wetter daten werden automatisch beruchsichtig', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        label1.grid(row=1, column=3, padx=5, pady=3)

        Anzahl = tk.Label(produktFrame1, text='Anzahl', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Anzahl.grid(row=0, column=4, padx=5, pady=3)
        windFrame.txt_Anzahl = tk.Entry(produktFrame1, width=10)
        windFrame.txt_Anzahl.grid(row=0, column=5)

        button1 = tk.Button(produktFrame1, text='Löschen', **style.STYLE, activebackground=style.BACKGROUND,
                            activeforeground=style.TEXT)
        button1.grid(row=1, column=5, padx=5, pady=3)

# Produkt 3
        produktFrame2 = tk.Frame(windFrame)
        produktFrame2.config(background='blue')  # style.BACKGROUND)
        produktFrame2.pack(side=tk.TOP, fill=tk.X, padx=10, pady=8)  # (row=0, column=0)

        Hersteller = tk.Label(produktFrame2, text='Hersteller', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Hersteller.grid(row=0, column=0, padx=5, pady=3)
        windFrame.cbx_Hersteller = ttk.Combobox(produktFrame2, width=50)
        Hersteller = ('', 'Enercon', 'Vestas', 'Siemens-Gamesa', 'Nordex')
        windFrame.cbx_Hersteller['values'] = Hersteller
        windFrame.cbx_Hersteller.current(0)
        windFrame.cbx_Hersteller.grid(row=0, column=1)

        Standort = tk.Label(produktFrame2, text='Standort', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Standort.grid(row=1, column=0, padx=5, pady=3)
        windFrame.cbx_Standort = ttk.Combobox(produktFrame2, width=50)
        Standort = ('', 'Schleswig-Holstein A', 'Schleswig-Holstein B', 'Schleswig-Holstein C',
                    'Schleswig-Holstein D', 'Schleswig-Holstein E', 'Schleswig-Holstein F', 'Hamburg')
        windFrame.cbx_Standort['values'] = Standort
        windFrame.cbx_Standort.current(0)
        ...
        Modellname = tk.Label(produktFrame2, text='Modellname', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Modellname.grid(row=0, column=2, padx=5, pady=3)
        windFrame.cbx_Modellname = ttk.Combobox(produktFrame2, width=50)
        Modellname = ('', 'AAA', 'BBB', 'CCC', 'DDD', 'EEE',)
        windFrame.cbx_Modellname['values'] = Modellname
        windFrame.cbx_Modellname.current(0)
        windFrame.cbx_Modellname.grid(row=0, column=3)

        label1 = tk.Label(produktFrame2, text='Wetter daten werden automatisch beruchsichtig', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        label1.grid(row=1, column=3, padx=5, pady=3)

        Anzahl = tk.Label(produktFrame2, text='Anzahl', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Anzahl.grid(row=0, column=4, padx=5, pady=3)
        windFrame.txt_Anzahl = tk.Entry(produktFrame2, width=10)
        windFrame.txt_Anzahl.grid(row=0, column=5)

        button1 = tk.Button(produktFrame2, text='Löschen', **style.STYLE, activebackground=style.BACKGROUND,
                            activeforeground=style.TEXT)
        button1.grid(row=1, column=5, padx=5, pady=3)

# Produkt 4
        produktFrame3 = tk.Frame(windFrame)
        produktFrame3.config(background='blue')  # style.BACKGROUND)
        produktFrame3.pack(side=tk.TOP, fill=tk.X, padx=10, pady=8)  # (row=0, column=0)

        Hersteller = tk.Label(produktFrame3, text='Hersteller', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Hersteller.grid(row=0, column=0, padx=5, pady=3)
        windFrame.cbx_Hersteller = ttk.Combobox(produktFrame3, width=50)
        Hersteller = ('', 'Enercon', 'Vestas', 'Siemens-Gamesa', 'Nordex')
        windFrame.cbx_Hersteller['values'] = Hersteller
        windFrame.cbx_Hersteller.current(0)
        windFrame.cbx_Hersteller.grid(row=0, column=1)

        Standort = tk.Label(produktFrame3, text='Standort', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Standort.grid(row=1, column=0, padx=5, pady=3)
        windFrame.cbx_Standort = ttk.Combobox(produktFrame3, width=50)
        Standort = ('', 'Schleswig-Holstein A', 'Schleswig-Holstein B', 'Schleswig-Holstein C',
                    'Schleswig-Holstein D', 'Schleswig-Holstein E', 'Schleswig-Holstein F', 'Hamburg')
        windFrame.cbx_Standort['values'] = Standort
        windFrame.cbx_Standort.current(0)
        ...
        Modellname = tk.Label(produktFrame3, text='Modellname', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Modellname.grid(row=0, column=2, padx=5, pady=3)
        windFrame.cbx_Modellname = ttk.Combobox(produktFrame3, width=50)
        Modellname = ('', 'AAA', 'BBB', 'CCC', 'DDD', 'EEE',)
        windFrame.cbx_Modellname['values'] = Modellname
        windFrame.cbx_Modellname.current(0)
        windFrame.cbx_Modellname.grid(row=0, column=3)

        label1 = tk.Label(produktFrame3, text='Wetter daten werden automatisch beruchsichtig', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        label1.grid(row=1, column=3, padx=5, pady=3)

        Anzahl = tk.Label(produktFrame3, text='Anzahl', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Anzahl.grid(row=0, column=4, padx=5, pady=3)
        windFrame.txt_Anzahl = tk.Entry(produktFrame3, width=10)
        windFrame.txt_Anzahl.grid(row=0, column=5)

        button1 = tk.Button(produktFrame3, text='Löschen', **style.STYLE, activebackground=style.BACKGROUND,
                            activeforeground=style.TEXT)
        button1.grid(row=1, column=5, padx=5, pady=3)

# Produkt 5
        produktFrame4 = tk.Frame(windFrame)
        produktFrame4.config(background='blue')  # style.BACKGROUND)
        produktFrame4.pack(side=tk.TOP, fill=tk.X, padx=10, pady=8)  # (row=0, column=0)

        Hersteller = tk.Label(produktFrame4, text='Hersteller', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Hersteller.grid(row=0, column=0, padx=5, pady=3)
        windFrame.cbx_Hersteller = ttk.Combobox(produktFrame4, width=50)
        Hersteller = ('', 'Enercon', 'Vestas', 'Siemens-Gamesa', 'Nordex')
        windFrame.cbx_Hersteller['values'] = Hersteller
        windFrame.cbx_Hersteller.current(0)
        windFrame.cbx_Hersteller.grid(row=0, column=1)

        Standort = tk.Label(produktFrame4, text='Standort', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Standort.grid(row=1, column=0, padx=5, pady=3)
        windFrame.cbx_Standort = ttk.Combobox(produktFrame4, width=50)
        Standort = ('', 'Schleswig-Holstein A', 'Schleswig-Holstein B', 'Schleswig-Holstein C',
                    'Schleswig-Holstein D', 'Schleswig-Holstein E', 'Schleswig-Holstein F', 'Hamburg')
        windFrame.cbx_Standort['values'] = Standort
        windFrame.cbx_Standort.current(0)
        ...
        Modellname = tk.Label(produktFrame4, text='Modellname', **style.STYLE,
                              activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Modellname.grid(row=0, column=2, padx=5, pady=3)
        windFrame.cbx_Modellname = ttk.Combobox(produktFrame4, width=50)
        Modellname = ('', 'AAA', 'BBB', 'CCC', 'DDD', 'EEE',)
        windFrame.cbx_Modellname['values'] = Modellname
        windFrame.cbx_Modellname.current(0)
        windFrame.cbx_Modellname.grid(row=0, column=3)

        label1 = tk.Label(produktFrame4, text='Wetter daten werden automatisch beruchsichtig', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        label1.grid(row=1, column=3, padx=5, pady=3)

        Anzahl = tk.Label(produktFrame4, text='Anzahl', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Anzahl.grid(row=0, column=4, padx=5, pady=3)
        windFrame.txt_Anzahl = tk.Entry(produktFrame4, width=10)
        windFrame.txt_Anzahl.grid(row=0, column=5)

        button1 = tk.Button(produktFrame4, text='Löschen', **style.STYLE, activebackground=style.BACKGROUND,
                            activeforeground=style.TEXT)
        button1.grid(row=1, column=5, padx=5, pady=3)
