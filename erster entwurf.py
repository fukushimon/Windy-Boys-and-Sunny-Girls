...
class StartPage(tk.Frame):
     def __init__(self, master):
        ...
        tk.Frame.configure(self, bg='blue', width=1500, height=800)
        frame1 = tk.LabelFrame(self, text="Start page", font=('Helvetica', 18, "bold")).pack(side="top", fill="x", pady=5)
    ...
    #frame1 = tk.Label(text='datos de cliente', font=('calibri', 14))
    #frame1.pack(self , fill='both', expand='yes', padx=20, pady=15)
