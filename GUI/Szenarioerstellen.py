...
# Frame Wind
        ...
        Hersteller = tk.Label(windFrame, text='Hersteller', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Hersteller.grid(row=0, column=0, padx=5, pady=3)
        windFrame.cbx_Hersteller = ttk.Combobox(windFrame, width=50)
        ...
        Standort = tk.Label(windFrame, text='Standort', **style.STYLE,
                           activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Standort.grid(row=1, column=0, padx=5, pady=3)
        windFrame.cbx_Standort = ttk.Combobox(windFrame, width=50)
        ...
        Modellname = tk.Label(windFrame, text='Modellname', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Modellname.grid(row=0, column=2, padx=5, pady=3)
        windFrame.cbx_Modellname = ttk.Combobox(windFrame, width=50)
        ...
        label1 = tk.Label(windFrame, text='Wetter daten werden automatisch beruchsichtig', **style.STYLE,
                            activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        label1.grid(row=1, column=3, padx=5, pady=3)


        Anzahl = tk.Label(windFrame, text='Anzahl', **style.STYLE,
                          activebackground=style.BACKGROUND, activeforeground=style.TEXT)
        Anzahl.grid(row=0, column=4, padx=5, pady=3)
        windFrame.txt_Anzahl = tk.Entry(windFrame, width=10)
        windFrame.txt_Anzahl.grid(row=0, column=5)

        button1 = tk.Button(windFrame, text='Löschen', **style.STYLE,activebackground=style.BACKGROUND, activeforeground=style.TEXT)
